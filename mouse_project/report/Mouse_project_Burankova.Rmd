...
## 4.3. New linear regression after PCA
...
## 4.4. Plot 3D plot (3 principal components)
...
```{r echo=FALSE}
library(plot3D)
plot3D::scatter3D(pca_scores_17$PC1, pca_scores_17$PC2, pca_scores_17$PC3, theta = 15, d = 2, phi = 16,
